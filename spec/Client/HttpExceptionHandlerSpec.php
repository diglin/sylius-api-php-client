...
use Diglin\Sylius\ApiClient\Client\HttpExceptionHandler;
use Diglin\Sylius\ApiClient\Exception\BadRequestHttpException;
use Diglin\Sylius\ApiClient\Exception\ClientErrorHttpException;
use Diglin\Sylius\ApiClient\Exception\NotFoundHttpException;
use Diglin\Sylius\ApiClient\Exception\RedirectionHttpException;
use Diglin\Sylius\ApiClient\Exception\ServerErrorHttpException;
use Diglin\Sylius\ApiClient\Exception\UnauthorizedHttpException;
use Diglin\Sylius\ApiClient\Exception\UnprocessableEntityHttpException;
...
class HttpExceptionHandlerSpec extends ObjectBehavior
{
    ...
    public function it_throws_redirection_exception_when_status_code_3xx(
    ...
    public function it_throws_bad_request_exception_when_status_code_400(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_throws_unauthorized_request_exception_when_status_code_401(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_throws_not_found_exception_when_status_code_404(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_throws_bad_request_exception_when_status_code_422(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_throws_bad_request_exception_when_status_code_4xx(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_throws_bad_request_exception_when_status_code_5xx(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_returns_the_response_when_succesful_response(RequestInterface $request, ResponseInterface $response)
    {
        $response->getStatusCode()->willReturn(200);
        $this->transformResponseToException($request, $response)->shouldReturn($response);
    }

    public function it_builds_exception_with_reason_phrase_when_response_has_no_message(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
    ...
    public function it_builds_exception_with_reason_phrase_when_response_is_not_a_valid_json(
        RequestInterface $request,
        ResponseInterface $response,
        StreamInterface $responseBody
    ) {
