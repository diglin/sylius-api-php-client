...
{
    public function let(StreamInterface $stream, LineStreamReader $streamReader)
    {
    ...
    public function it_returns_the_list_of_responses_line_by_line_when_iterating($stream, $streamReader)
    {
        $lines = [
