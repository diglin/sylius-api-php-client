...
interface ProductReviewsApiInterface extends ApiAwareInterface, CreatableResourceInterface, GettableDoubleResourceInterface, ListableDoubleResourceInterface, DeletableDoubleResourceInterface
{
}
