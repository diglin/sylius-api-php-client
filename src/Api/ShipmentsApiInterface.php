...
interface ShipmentsApiInterface extends ApiAwareInterface, GettableResourceInterface, ListableResourceInterface, DeletableResourceInterface, CreatableResourceInterface
{
}
