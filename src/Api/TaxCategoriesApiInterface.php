...
interface TaxCategoriesApiInterface extends ApiAwareInterface, GettableResourceInterface, ListableResourceInterface, DeletableResourceInterface, CreatableResourceInterface
{
}
