...
final class CurrencyApi implements CurrencyApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/admin/currencies/%s', [$code]);
    }

    public function create($code, array $data = []): int
    {
        Assert::string($code);
        return $this->resourceClient->createResource('api/v2/admin/currencies', [], $data);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/currencies', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
