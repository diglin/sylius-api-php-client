...
final class CustomerGroupApi implements CustomerGroupApiInterface
{
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/customer-groups', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
    ...
    {
        Assert::string($code);
        return $this->resourceClient->upsertResource('api/v2/admin/customer-groups/%s', [$code], $data);
    }

    public function delete($code): int
    {
        Assert::string($code);
        return $this->resourceClient->deleteResource('api/v2/admin/customer-groups/%s', [$code]);
    }
}
