...
final class ProductImageApi implements ProductImageApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/admin/product-images/%d', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/product-images', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
