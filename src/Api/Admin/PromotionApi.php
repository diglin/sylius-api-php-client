...
final class PromotionApi implements PromotionApiInterface
{
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/promotions', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
