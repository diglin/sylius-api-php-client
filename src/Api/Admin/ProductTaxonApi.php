...
final class ProductTaxonApi implements ProductTaxonApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/admin/product-taxons/%d', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/product-taxons', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
