...
final class ProductAssociationTypeApi implements ProductAssociationTypeApiInterface
{
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/product-association-types', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
    ...
    {
        Assert::string($code);
        return $this->resourceClient->deleteResource('api/v2/admin/product-association-types/%s', [$code]);
    }
}
