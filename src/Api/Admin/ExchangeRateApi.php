...
final class ExchangeRateApi implements ExchangeRateApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/admin/exchange-rates/%d', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/exchange-rates', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->upsertResource('api/v2/admin/exchange-rates/%d', [$code], $data);
    }

    public function delete($code): int
    {
        Assert::integer($code);
        return $this->resourceClient->deleteResource('api/v2/admin/exchange-rates/%d', [$code]);
    }
}
