...
class TaxCategoriesApi implements TaxCategoriesApiInterface
{
    use ApiAwareTrait;

    public const ENDPOINT_URI = 'api/v1/tax-categories/%s';
    public const ENDPOINTS_URI = 'api/v1/tax-categories';
