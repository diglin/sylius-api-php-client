...
class ProductOptionsApi implements ProductOptionsApiInterface
{
    use ApiAwareTrait;

    public const ENDPOINT_URI = 'api/v1/product-options/%s';
    public const ENDPOINTS_URI = 'api/v1/product-options';
