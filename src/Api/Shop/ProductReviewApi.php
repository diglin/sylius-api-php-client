...
final class ProductReviewApi implements ProductReviewApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/product-reviews/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/product-reviews', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->createResource('api/v2/shop/product-reviews', [], $data);
    }
}
