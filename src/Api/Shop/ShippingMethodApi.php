...
final class ShippingMethodApi implements ShippingMethodApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/shipping-methods/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/shipping-methods', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
