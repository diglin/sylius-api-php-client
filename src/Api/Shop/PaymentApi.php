...
final class PaymentApi implements PaymentApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/payments/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/payments', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
