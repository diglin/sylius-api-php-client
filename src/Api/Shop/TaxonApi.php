...
final class TaxonApi implements TaxonApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/taxons/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/taxons', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
