...
final class AddressApi implements AddressApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/shop/addresses/%s');
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/addresses');
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->upsertResource('api/v2/shop/addresses/%d', [$code], $data);
    }

    public function delete($code): int
    {
        Assert::integer($code);
        return $this->resourceClient->deleteResource('api/v2/shop/addresses/%d', [$code]);
    }
}
