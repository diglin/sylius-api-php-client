...
final class PaymentMethodApi implements PaymentMethodApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/payment-methods/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/payment-methods', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
