...
final class ProductApi implements ProductApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/products/%s', [$code]);
    }

    public function getBySlug(string $slug): array
    {
        return $this->resourceClient->getResource('api/v2/shop/products-by-slug/%s', [$slug]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/products', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
