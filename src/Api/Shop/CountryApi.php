...
class CountryApi implements CountryApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/shop/countries/%d', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/countries', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
