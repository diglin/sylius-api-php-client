...
final class ShipmentApi implements ShipmentApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/shipments/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/shipments', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
