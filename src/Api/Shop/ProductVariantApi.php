...
final class ProductVariantApi implements ProductVariantApiInterface
{
    ...
    {
        Assert::string($code);
        return $this->resourceClient->getResource('api/v2/shop/product-variants/%s', [$code]);
    }
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/shop/product-variants', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
