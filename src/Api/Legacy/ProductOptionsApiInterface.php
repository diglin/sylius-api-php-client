...
/** @deprecated */
interface ProductOptionsApiInterface extends ApiAwareInterface, GettableResourceInterface, ListableResourceInterface, CreatableResourceInterface, DeletableResourceInterface
{
}
