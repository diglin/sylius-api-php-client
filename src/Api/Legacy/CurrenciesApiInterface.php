...
/** @deprecated */
interface CurrenciesApiInterface extends ApiAwareInterface, GettableResourceInterface, ListableResourceInterface, DeletableResourceInterface, CreatableResourceInterface
{
}
