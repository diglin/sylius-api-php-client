...
/** @deprecated */
class PaymentMethodsApi implements PaymentMethodsApiInterface
{
    use ApiAwareTrait;

    public const ENDPOINT_URI = 'api/v1/payment-methods/%s';
    public const ENDPOINTS_URI = 'api/v1/payment-methods';
