...
/** @deprecated */
interface PromotionCouponsApiInterface extends ApiAwareInterface, GettableDoubleResourceInterface, ListableDoubleResourceInterface, DeletableDoubleResourceInterface, CreatableResourceInterface
{
}
