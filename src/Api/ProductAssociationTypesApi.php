...
class ProductAssociationTypesApi implements ProductAssociationTypesApiInterface
{
    use ApiAwareTrait;

    public const ENDPOINT_URI = 'api/v1/product-association-types/%s';
    public const ENDPOINTS_URI = 'api/v1/product-association-types';
