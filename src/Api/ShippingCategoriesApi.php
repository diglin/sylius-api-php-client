...
class ShippingCategoriesApi implements ShippingCategoriesApiInterface
{
    use ApiAwareTrait;

    public const ENDPOINT_URI = 'api/v1/shipping-categories/%s';
    public const ENDPOINTS_URI = 'api/v1/shipping-categories';
